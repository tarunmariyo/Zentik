    ...
    <div className="min-h-screen pt-32 pb-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.section
          ...
          className="mb-16"
        >
          <div className="bg-gradient-to-br from-dark to-gray-900 p-8 md:p-12 rounded-2xl border border-[var(--border-color)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={index} className="text-center p-4">
                  ...
                  <p className="text-[var(--text-tertiary)]">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {internships.map((internship, index) => (
              <motion.div
                ...
                className="bg-gradient-to-br from-dark to-gray-900 p-6 rounded-xl border border-[var(--border-color)] hover:border-primary/50 transition-all duration-300"
              >
                {/* Header */}
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-14 h-14 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <internship.icon className="text-2xl text-primary" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-[var(--text-primary)]">{internship.title}</h3>
                    <p className="text-primary">{internship.department}</p>
                  </div>
                ...
                {/* Meta Info */}
                <div className="flex flex-wrap gap-4 mb-4 text-sm text-[var(--text-tertiary)]">
        ...
        <motion.section
          ...
          transition={{ duration: 0.6 }}
        >
          <div className="bg-gradient-to-br from-primary/20 to-primary/10 p-8 md:p-12 rounded-2xl border border-primary/30 text-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-primary hover:bg-[#007A8C] text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-primary/50"
            >
              <FaEnvelope />
              Send Resume to contact@zentik.info
            </a>
            <p className="text-[var(--text-tertiary)] mt-6 text-sm">
